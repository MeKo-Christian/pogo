...
// printModelMetadata prints model metadata information.
func printModelMetadata(modelPath string) {
...
// testModelCompatibility tests a single model's compatibility and prints results.
func testModelCompatibility(modelName, modelPath string) {
...
func main() {
	...
	for _, modelName := range models {
		...
		testModelCompatibility(modelName, modelPath)
	}
